...
public class SubArea {
	...
	public ArrayList<RouteSection> getSubArea(ArrayList<RouteSection> routeSections,
													double x1,double x2,double y1,double y2)
	{
		ArrayList<RouteSection> subRouteSection = new ArrayList<RouteSection>();
		for(int i=0;i<routeSections.size();i++)
		{
			if(routeSections.get(i).I1.x>=x1 &&routeSections.get(i).I1.x<=x2
					&&routeSections.get(i).I1.y>=y1 && routeSections.get(i).I1.y<=y2)
				
				if(routeSections.get(i).I2.x>=x1 &&routeSections.get(i).I2.x<=x2
					&&routeSections.get(i).I2.y>=y1 && routeSections.get(i).I2.y<=y2)
	...
	public ArrayList<Vector> getSubAreaV(ArrayList<Vector> vectors,
													double x1,double x2,double y1,double y2)
	{
